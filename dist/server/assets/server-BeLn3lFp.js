...
import { g as getDefaultExportFromCjs } from "./worker-entry-SEizlAOM.js";
...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-DbQoe8pX.js");
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-ChM-Htb1.js").then((n2) => n2.a9),
    import("./start-DtfCHpOq.js"),
