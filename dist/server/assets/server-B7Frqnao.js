...
import { g as getDefaultExportFromCjs } from "./worker-entry-lb6AVIsX.js";
...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-D7DYXeok.js");
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router--dyNfIM0.js").then((n2) => n2.ab),
    import("./start-CyCX3fwI.js"),
